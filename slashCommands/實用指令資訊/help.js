...
module.exports = {
    ...
    options: [{
        ...
        type: 'STRING',
        choices:[
            { name: '公告頻道設置', value: '公告頻道設置' },
            { name: '公告發送', value: '公告發送' },
            { name: '加入訊息設置', value: '加入訊息設置' },
            { name: '加入身份組刪除', value: '加入身份組刪除' },
            { name: '加入身份組設置', value: '加入身份組設置' },
            { name: '驗證設置', value: '驗證設置' },
            { name: '私人頻道刪除', value: '私人頻道刪除' },
            { name: '抽獎設置', value: '抽獎設置' },
            { name: '播放資訊', value: '播放資訊' },
            { name: '播放', value: '播放' },
            { name: '聊天經驗刪除', value: '聊天經驗刪除' },
            { name: '聊天經驗', value: '聊天經驗' },
            { name: '語音經驗刪除', value: '語音經驗刪除' },
            { name: '語音經驗設定', value: '語音經驗設定' },
            { name: '語音經驗', value: '語音經驗' },
            { name: '遊玩時數查詢', value: '遊玩時數查詢' },
            { name: '刪除訊息', value: '刪除訊息' },
            { name: '設置日誌頻道', value: '設置日誌頻道' },
            { name: '選取身分組設定', value: '選取身分組設定' },
            { name: '語音包廂刪除', value: '語音包廂刪除' },
            { name: '語音包廂設置', value: '語音包廂設置' },
            { name: '統計系統創建', value: '統計系統創建' },
            { name: '統計系統刪除', value: '統計系統刪除' },
            { name: '統計系統查詢', value: '統計系統查詢' },
        ]
