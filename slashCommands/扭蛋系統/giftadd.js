                    ...
                    return interaction.editReply({
                        embeds:[
                            ...
                            .addFields(
                                ...
                                { name: '<:counter:994585977207140423> **獎品數量:**', value: `${gift_count}個`, inline: true},
                                { name: '<:trashbin:995991389043163257> **自動刪除:**', value: `${auto_delete}`, inline: true},
                                { name: '<:givemoney:1019632789110399068> **給予代幣數:**', value: `${give_coin}個`, inline: true}
                            )
