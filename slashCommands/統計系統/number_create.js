        ...
        try {
            ...
            Number.findOne({
                ...
                if (!data) {
                    ...
                    const lodding = await interaction.followUp({
                        embeds: [lodd]
                    })
                        ...
                        switch (member) {
                            ...
                            case "頻道數量":
                                ...
                                data.collection.updateOne(({
                                    ...
                                    $set: {
                                        channelnumber: `${botnumber_text.id}`
                                    }
                                })
                                data.collection.updateOne(({
                                    guild: interaction.guild.id,
                            ...
                            case "語音頻道數量":
                                ...
                                data.collection.updateOne(({
                                    ...
                                    $set: {
                                        voicenumber_name: `${text_channel_number}`
                                    }
                                })
                                interaction.followUp({
                                    embeds: [embed]
